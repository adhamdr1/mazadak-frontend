...
export const MOCK_AUCTIONS: Auction[] = [
  ...
  {
    _id: '66cbfa84128f6d78a9c1e001',
    sellerId: '66cbfa84128f6d78a9c1a002',
  ...
  // 3. CARS - ACTIVE
  {
    _id: '66cbfa84128f6d78a9c1e003',
    sellerId: '66cbfa84128f6d78a9c1a001',
  ...
  {
    _id: '66cbfa84128f6d78a9c1e004',
    sellerId: '66cbfa84128f6d78a9c1a003',
    ...
    status: 'ACTIVE',
    startTime: new Date(now.getTime() - 1 * DAY).toISOString(),
    endTime: new Date(now.getTime() + 2 * DAY).toISOString(), // 2 days -> "يومان"
    winnerId: null,
    isFinalized: false,
  ...
  // 5. ELECTRONICS - ACTIVE (Ends in 1 day -> tests "يوم")
  {
    ...
    currentPrice: '154000',
    status: 'ACTIVE',
    startTime: new Date(now.getTime() - 6 * HOUR).toISOString(),
    endTime: new Date(now.getTime() + 1 * DAY).toISOString(), // 1 day -> "يوم"
    winnerId: null,
    isFinalized: false,
    createdAt: new Date(now.getTime() - 1 * DAY).toISOString(),
  ...
  // 6. JEWELRY - ACTIVE (Ends in 4 days -> tests "4 أيام")
  {
    ...
    endTime: new Date(now.getTime() + 4 * DAY).toISOString(), // 4 days -> "4 أيام"
    winnerId: null,
    isFinalized: false,
    createdAt: new Date(now.getTime() - 2 * DAY).toISOString(),
  ...
  // 7. ART - ACTIVE
  {
    ...
    status: 'ACTIVE',
    startTime: new Date(now.getTime() - 2 * DAY).toISOString(),
    endTime: new Date(now.getTime() + 3 * DAY + 10 * HOUR).toISOString(),
    winnerId: null,
    isFinalized: false,
  ...
  // 8. ANTIQUES - ACTIVE
  {
    ...
    endTime: new Date(now.getTime() + 1 * DAY + 14 * HOUR).toISOString(),
    winnerId: null,
    isFinalized: false,
    createdAt: new Date(now.getTime() - 6 * DAY).toISOString(),
    updatedAt: new Date(now.getTime() - 8 * HOUR).toISOString(),
  },

  // 9. CARS - PENDING (Starts in 1 day)
  {
    _id: '66cbfa84128f6d78a9c1e009',
    sellerId: '66cbfa84128f6d78a9c1a001',
    ...
    status: 'PENDING',
    startTime: new Date(now.getTime() + 1 * DAY + 4 * HOUR).toISOString(),
  ...
  // 10. WATCHES - PENDING (Starts in 6 hours)
  {
    _id: '66cbfa84128f6d78a9c1e010',
    sellerId: '66cbfa84128f6d78a9c1a002',
  ...
  // 15. SPORTS - ACTIVE (Ends in 14 days -> tests "14 يوم")
  {
    ...
    status: 'ACTIVE',
    startTime: new Date(now.getTime() - 1 * DAY).toISOString(),
    endTime: new Date(now.getTime() + 14 * DAY).toISOString(), // 14 days -> "14 يوم"
    winnerId: null,
    isFinalized: false,
    createdAt: new Date(now.getTime() - 2 * DAY).toISOString(),
  ...
  // 17. TOYS - ACTIVE
  {
    ...
    status: 'ACTIVE',
    startTime: new Date(now.getTime() - 1 * DAY).toISOString(),
    endTime: new Date(now.getTime() + 2 * DAY + 12 * HOUR).toISOString(),
    winnerId: null,
    isFinalized: false,
    createdAt: new Date(now.getTime() - 2 * DAY).toISOString(),
    updatedAt: new Date(now.getTime() - 4 * HOUR).toISOString(),
  ...
  // 18. CARS - ENDED (Won)
  {
    ...
    status: 'ENDED',
    startTime: new Date(now.getTime() - 7 * DAY).toISOString(),
    endTime: new Date(now.getTime() - 1 * DAY).toISOString(),
    winnerId: '66cbfa84128f6d78a9c1a999',
    isFinalized: true,
